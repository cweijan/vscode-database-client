...
export class CatalogNode extends Node implements CopyAble {
    ...
    public dropDatatabase() {
        ...
        vscode.window.showInputBox({ prompt: `Are you sure you want to drop the database ${this.schema} ?     `, placeHolder: 'Input database name to confirm.' }).then(async (inputContent) => {
