...
export class TableNode extends Node implements CopyAble {
    ...
    public dropTable() {
        ...
        Util.confirm(`Are you sure you want to drop the table ${this.table} ? `, async () => {
    ...
    public truncateTable() {
        ...
        Util.confirm(`Are you sure you want to clear all data from the table ${this.table} ?`, async () => {
